...
#load("CHO_Age_Stand.RData")
#load("CHO_Crude.RData")
#load("CVD_Cerebrovascular_DALY.RData")
#load("CVD_Cerebrovascular.RData")
#load("CVD_Ischaemic_DALY.RData")
#load("CVD_Ischaemic.RData")
